...
import static com.absinthe.libraries.axml.axml.AxmlParser.END_FILE;
import static com.absinthe.libraries.axml.axml.AxmlParser.END_NS;
import static com.absinthe.libraries.axml.axml.AxmlParser.END_TAG;
import static com.absinthe.libraries.axml.axml.AxmlParser.START_FILE;
import static com.absinthe.libraries.axml.axml.AxmlParser.START_NS;
import static com.absinthe.libraries.axml.axml.AxmlParser.START_TAG;
import static com.absinthe.libraries.axml.axml.AxmlParser.TEXT;
    ...
    while (true) {
      ...
      switch (type) {
        ...
        case END_FILE:
          return;
        default:
          Log.d("AxmlReader", "Unsupported tag: " + type);
      }
    }
  }
}
